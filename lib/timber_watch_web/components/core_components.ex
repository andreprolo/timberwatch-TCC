defmodule TimberWatchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TimberWatchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TimberWatchWeb.Gettext, "errors", msg, opts)
    end
  end
